...
You might want to take a look at zoocfg.tmpl template file before using this and make sure keystore/truststore location is correct and password is defined.
