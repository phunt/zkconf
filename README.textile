...
If servers option is provided, zkconf will generate shell scripts which help you to upload ZooKeeper files and start/stop ensemble remotely. For example when you want to start a "real" ensemble running on separate machines / VMs. 
